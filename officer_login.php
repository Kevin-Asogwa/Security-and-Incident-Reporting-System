...
<body>
    ...
    <main class="main">
        <div class="container">
            ...
            <form action="admin/officer.login.inc.php" method="POST" class="login-form">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="officer_id" id="officer_id" class="form-control" placeholder="Input your Security ID">
                </div>
                <div class="form-group">
            ...
            <p>Don't have an account? <a href="#" class="register">Contact the IT Admin to create a security officer account</a></p>
        </div>
    </main>
